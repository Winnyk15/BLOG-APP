...
Run 
``git clone https://github.com/Winnyk15/blog-X.git``
...
| Password  | Account password, ``eg parseword``|
| Confirm Password  | Account password, ``eg parsewo
...
## License
> MIT License &copy; 2020 Winnie Kahendah

## Collaborate
To collaborate, reach me on [kahendahwinnie@gmail.com]()
